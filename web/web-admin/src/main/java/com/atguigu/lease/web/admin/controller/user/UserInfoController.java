...
public class UserInfoController {
    ...
    public Result<IPage<UserInfo>> pageUserInfo(@RequestParam long current, @RequestParam long size, UserInfoQueryVo queryVo) {
        ...
        userInfoLambdaQueryWrapper.eq(queryVo.getStatus()!=null, UserInfo::getStatus, BaseStatus.ENABLE.getCode());
        Page<UserInfo> userInfoIPage = userInfoService.page(page, userInfoLambdaQueryWrapper);
